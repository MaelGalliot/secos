...
/*
 * Initialise la GDT avec : un segment NULL
 */
void init_gdt(){
  ...
  //Init du segment 0 - null
  memset((void *)&GDT[0],0,sizeof(seg_desc_t));
...
void tp(){
 // display_gdt();
  ...
  add_desc_gdt(4,0,0xfffff,SEG_DESC_CODE_XR,3);
  add_desc_gdt(5,0,0xfffff,SEG_DESC_DATA_RW,3);  
  display_gdt();
